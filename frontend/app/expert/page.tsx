...
export default function ExpertPage() {
  ...
  if (user?.role === "USER" || !user) {
    return (
      <div className="min-h-screen bg-brand-gray flex items-center justify-center p-4 sm:p-8">
        <div className="max-w-md text-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-6">
            <Lock className="w-7 h-7 sm:w-9 sm:h-9 text-gray-400" />
          </div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">Accès Restreint</h2>
        ...
        <div className="max-w-2xl mx-auto">
          <header className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-extrabold text-gray-900">Espace Expert</h1>
                <p className="text-xs sm:text-sm text-orange-600 font-medium">Accès avancé activé</p>
              </div>
            </div>
          </header>
    ...
    <div className="min-h-screen bg-brand-gray p-4 sm:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-2">
            <div>
              <h1 className="text-xl sm:text-2xl font-extrabold text-gray-900">Gestion des Accès</h1>
              <p className="text-xs sm:text-sm text-red-600 font-medium">Espace Administration</p>
            </div>
          </div>
              ...
              <table className="w-full text-left text-sm">
                <thead className="bg-gray-50 border-b border-gray-100">
                  <tr>
                    ...
                    <th className="hidden md:table-cell px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">Email</th>
                      ...
                      <tr key={u.id} className="hover:bg-gray-50/40 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-brand-primary/10 flex items-center justify-center text-brand-primary font-bold text-xs sm:text-sm uppercase shrink-0">
                        ...
                        <td className="px-6 py-4">
                          <span className={`inline-flex items-center gap-1.5 text-[10px] sm:text-xs font-bold px-2.5 py-1 rounded-md ${meta.badge}`}>
                            <MetaIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                        ...
                        <td className="px-6 py-4 text-right">
                          {updatingId === u.id ? (
                            ...
                            <select
                              ...
                              className="bg-white border border-gray-200 text-gray-700 text-[10px] sm:text-xs font-bold rounded-lg px-2 sm:px-3 py-2 ml-auto block outline-none hover:border-gray-300 cursor-pointer transition-colors focus:ring-2 focus:ring-red-100 focus:border-red-300"
                            >
